...
class OrderService {
    getAllOrders() {
        return __awaiter(this, void 0, void 0, function* () {
            return order_repository_1.default.getAll();
        });
    }
    getOrderById(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getOrderDetailById(order_id) {
        return __awaiter(this, void 0, void 0, function* () {
            return order_repository_1.default.findDetailById(order_id);
        });
    }
    generateOrder(newOrder) {
        return __awaiter(this, void 0, void 0, function* () {
            return order_repository_1.default.createOrder(newOrder);
        });
    }
}
