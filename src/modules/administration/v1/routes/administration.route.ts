...
import { getAll, getSupplierById, createSupplier } from '../controllers/supplier.controller';
import { getAllCustomers, getAllCustomerCategory, getCustomerById, addCustomer } from '../controllers/customer.controller';
...
adminRouter.get('/v1/customer-categories', getAllCustomerCategory);
...
adminRouter.get('/v1/suppliers', getAll);
adminRouter.get('/v1/suppliers/:id', getSupplierById);
adminRouter.post('/v1/suppliers', createSupplier);
